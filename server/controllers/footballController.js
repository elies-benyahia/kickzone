// controllers/footballController.js — chaque route football = lire un paramètre, appeler le service.
// wrap() transforme "async (req) => data" en handler Express (envoi JSON + gestion d'erreur).
